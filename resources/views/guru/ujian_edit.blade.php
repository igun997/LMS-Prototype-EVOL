          ...
          <div class="row">
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_ujian" value="{{$selected->nama_ujian}}">
              </div>
              <div class="form-group">
                <label>Tgl. Dibuka</label>
                <input type="text" class="form-control date" name="tgl_dibuka" value="{{$selected->tgl_dibuka}}">
              </div>
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="type" class="form-control">
                        @foreach(\App\Casts\UjianType::select($selected->type) as $key => $row)
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#form").on('submit', function(event) {
      ...
      console.log(dform);
      urlFeed = "{{route("guru.ujian.api.edit")}}/{{$selected->id}}";
